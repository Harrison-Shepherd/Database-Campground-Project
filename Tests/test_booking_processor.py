...
class TestBookingProcessor(unittest.TestCase):
    ...
    def test_process_bookings_success(self):
        ...
        Also checks that the SQL update is called to reflect the booking in the Head Office database.
        """
        ...
        # Ensure that the SQL update was called to reflect the change in the Head Office database
        self.head_office_conn.cursor().execute.assert_called()
    ...
    def test_process_bookings_no_campsites(self):
        ...
        self.campsites[0].book_campsite(start_date, end_date)
